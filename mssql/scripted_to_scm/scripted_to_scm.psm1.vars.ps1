...
$SCRIPT:change_check_log = "$($my_dir)\html\change_check_log.xml"
$SCRIPT:change_html_every = "$($my_dir)\html\every_check.html"
$SCRIPT:change_html_changes = "$($my_dir)\html\changes_detected.html"
