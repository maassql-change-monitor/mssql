...
{
  write-host "set_directory_read_only_false - BEGIN - [$dir_to_nuke]"   
  ...
  {
    write-host "     Is set true.  Setting to False."  
  ...
  write-host "set_directory_read_only_false - END - [$dir_to_nuke]"    
  return $null
}